  ...
  opts = {
    ...
    checkbox = {
      ...
      custom = {
        ...
        in_progress = { raw = "[~]", rendered = "󱎫 ", highlight = "RenderMarkdownInProgress" },
        pending = { raw = "[p]", rendered = "󰪥 ", highlight = "RenderMarkdownPending" }, -- Icon buffer/loading
        important = { raw = "[!]", rendered = "󰀦 ", highlight = "RenderMarkdownImportant" },
        question = { raw = "[q]", rendered = "󰞋 ", highlight = "RenderMarkdownQuestion" }, -- Icon tanda tanya dalam hexagon
        blocked = { raw = "[b]", rendered = "✗", highlight = "RenderMarkdownBlocked" },
        review = { raw = "[r]", rendered = "󰍉 ", highlight = "RenderMarkdownReview" }, -- kaca pembesar basic
        need_followup = { raw = "[f]", rendered = "󰑎 ", highlight = "RenderMarkdownNeedFollowup" }, -- Icon panah melengkung/repeat/reload
      },
    },
    quote = {
